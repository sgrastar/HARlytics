...
<div class="">
    ...
    <div style="display: flex; flex-direction: column;">
      <div class="mb-3">
        ...
        <div class="flex gap-4">
          <Radio bind:group={imageFormat} value="png">PNG</Radio>
          <Radio bind:group={imageFormat} value="svg">SVG</Radio>
        </div>
      </div>
    ...
    <div style="display: flex; flex-direction: column;">
      {#if imageFormat === "png"}
        <div class="mb-2">
          ...
          <div class="flex gap-4">
            <Radio bind:group={sizeMode} value="auto">Auto</Radio>
            <Radio bind:group={sizeMode} value="width">Width</Radio>
            <Radio bind:group={sizeMode} value="height">Height</Radio>
          </div>
        </div>
  ...
  >
    ...
    <Button size="xs" color="light" on:click={showPreview}>
